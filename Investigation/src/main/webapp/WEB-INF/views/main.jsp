...
<head>
<meta charset="UTF-8">
<title>Investigation System</title>
<meta
...
<body class="skin-blue sidebar-mini">
	<div class="wrapper">
		<header class="main-header">
			<!-- Logo -->
			<a href="/investigation" class="logo"> 
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li>
								<a href="/investigation/introduction"><i class="fa fa-circle-o"></i>체계 소개</a>
							</li>
							<li>
								<a href="/investigation/how"><i class="fa fa-circle-o"></i>참여 방식</a>
							</li>
						</ul>
					</li>
					<li class="treeview">
